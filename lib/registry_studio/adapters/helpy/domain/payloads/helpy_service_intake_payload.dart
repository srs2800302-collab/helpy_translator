...
import '../helpy_registry_entity_kinds.dart';
...
final class HelpyServiceIntakePayload extends Equatable
  ...
  factory HelpyServiceIntakePayload({
    ...
    required HelpyIntakeEntityContent entity,
    ...
    return HelpyServiceIntakePayload._(
      schemaVersion: _requiredText(schemaVersion, 'schemaVersion'),
      entity: entity,
  ...
  final HelpyIntakeEntityContent entity;
  final List<HelpyIntakeScenario> scenarios;

  @override
  RegistryAdapterContractIdentity get adapterContract =>
      HelpyAdapterContract.identity;

  @override
  String get entityKindId => HelpyRegistryEntityKinds.serviceIntakeKindId;
  ...
  @override
  List<Object?> get props => <Object?>[schemaVersion, entity, scenarios];
}

final class HelpyIntakeEntityContent extends Equatable {
  factory HelpyIntakeEntityContent({
    required String semanticKey,
    required String displayName,
  }) {
    return HelpyIntakeEntityContent._(
      semanticKey: _requiredText(semanticKey, 'semanticKey'),
      displayName: _requiredText(displayName, 'displayName'),
    );
  }

  const HelpyIntakeEntityContent._({
  ...
  @override
  List<Object?> get props => <Object?>[semanticKey, displayName];
}
...
final class HelpyPhotoQuestionSource extends Equatable {
  factory HelpyPhotoQuestionSource({
    ...
    if (mode == HelpyPhotoSourceMode.reuse && !hasReference) {
      throw ArgumentError(
        'Reusable photo question must declare local source references.',
      );
    }

    if (mode != HelpyPhotoSourceMode.reuse &&
        (scenarioKey.isNotEmpty || photoQuestionKey.isNotEmpty)) {
      throw ArgumentError(
    ...
    return HelpyPhotoQuestionSource._(
      mode: mode,
      sourceScenarioKey: hasReference ? scenarioKey : null,
      sourcePhotoQuestionKey: hasReference ? photoQuestionKey : null,
    );
  }
