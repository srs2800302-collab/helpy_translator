...
void main() {
  group('RegistryEngineeringOperation', () {
    test('creates a normalized neutral lifecycle entity', () {
      ...
      expect(operation.decisionStatement, isNull);
    });

    test('rejects empty and whitespace-only problem statements', () {
      expect(
        () => RegistryEngineeringOperation(
    ...
    test('uses stable immutable identity for equality and hash code', () {
      final RegistryEngineeringOperationId id = RegistryEngineeringOperationId(
        'registry-operation-001',
      );
    ...
    test('does not require registry entity or related context', () {
      final RegistryEngineeringOperation operation =
          RegistryEngineeringOperation(
            id: RegistryEngineeringOperationId('registry-operation-001'),
    ...
    test('normalizes decision statement for decided status', () {
      final RegistryEngineeringOperation operation =
          RegistryEngineeringOperation(
            id: RegistryEngineeringOperationId('registry-operation-001'),
