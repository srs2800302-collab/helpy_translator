...
void main() {
  testWidgets('shows the loaded dictionary identity and collections', (
    WidgetTester tester,
  ) async {
    ...
    final _LoadedDictionaryLoader loader = _LoadedDictionaryLoader(dictionary);
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: BlocProvider<CanonicalDictionaryCubit>(
          ...
          child: Scaffold(
            appBar: AppBar(
              actions: <Widget>[CanonicalDictionaryStatusAction()],
            ),
          ),
        ),
      ),
